...
function register_jcisettings() {
	...
	register_setting( 'jci-options', 'jci_partner_global_id' );
}
	...
	<div class="leftsettings">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr>
					<td colspan="2">
						<strong>Partner Global Id<br></strong>
						<br>
						<input type="text" name="jci_partner_global_id" value="<?php echo get_option('jci_partner_global_id'); ?>" size="60"/>
					</td>
				</tr>
				<tr>
					<td colspan="2">
